                ...
                {voterMethod === "team" && (
                  <div className="bg-white/[0.01] border border-white/5 p-4 rounded-xl space-y-3">
                    ...
                    <div className="space-y-2 max-h-36 overflow-y-auto">
                      {[
                        { name: "Sarah Connor (Admin)", email: "sarah@securevote.io" },
                        { name: "John Doe (Manager)", email: "john@securevote.io" },
                        { name: "Kyle Reese (Viewer)", email: "kyle@securevote.io" }
                      ].map((member, i) => (
                        <label key={i} className="flex items-center gap-2.5 p-2 rounded-lg hover:bg-white/5 cursor-pointer text-xs">
                          <input type="checkbox" defaultChecked className="rounded border-white/10 bg-white/5 text-primary" />
